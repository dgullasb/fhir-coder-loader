...
public class ProcessSpreadsheetByYear {
    ...
    private static void processFile(File entry) throws OpenXML4JException, IOException, SAXException {
        ...
        if (filePath.endsWith(".xlsx") && filePath.contains("ep_ec_eh_unique_vs_")) {
            ...
            while (sheetsData.hasNext()) {
                ...
                System.out.println("worksheet: " + sheetsData.getSheetName());
                processSheet(styles, strings, getHandler(reportYear), stream);
                stream.close();
            }
        }
    }
    ...
    private static XSSFBSheetHandler.SheetContentsHandler getHandler(String reportYear) {
        return new XSSFBSheetHandler.SheetContentsHandler() {
            private String path = "target/gen-resources/" + reportYear + "/";
            ...
            private void processChildRow() throws IOException {
                ...
                if (!rowValues.get("B").equals(currentValueSetOID)) {
                    finishValueSet();
                    constructParentValueSet();
                }
                valueSet.getCompose().addInclude()
                        .setSystem((shortHandToSystemUrl.containsKey(rowValues.get("K")))?shortHandToSystemUrl.get(rowValues.get("K")):rowValues.get("K"))
                        .setVersion(rowValues.get("M"))
                        .addConcept(new ValueSet.ConceptReferenceComponent().setCode(rowValues.get("I")).setDisplay(rowValues.get("J")));
...
//                        .setValue(rowValues.get("A"));
            ...
            private void constructParentValueSet() {
                currentValueSetOID = rowValues.get("B");
                valueSet = new ValueSet()
                        .setName(rowValues.get("A"))
                        .setDescription(rowValues.get("E"))
                        .setVersion(rowValues.get("C"))
                        .setUrl("urn:oid:" + rowValues.get("B"))
            ...
            private boolean identifyTitleRow() {
                ...
                if (rowValues.containsKey("A") && rowValues.get("A").equals("Value Set Name") &&
                        rowValues.containsKey("B") && rowValues.get("B").equals("Value Set OID") &&
                        rowValues.containsKey("C") && rowValues.get("C").equals("Definition Version") &&
                        rowValues.containsKey("D") && rowValues.get("D").equals("Expansion Version") &&
                        rowValues.containsKey("E") && rowValues.get("E").equals("Purpose: Clinical Focus") &&
                        rowValues.containsKey("F") && rowValues.get("F").equals("Purpose: Data Element Scope") &&
                        rowValues.containsKey("G") && rowValues.get("G").equals("Purpose: Inclusion Criteria") &&
                        rowValues.containsKey("H") && rowValues.get("H").equals("Purpose: Exclusion Criteria") &&
                        rowValues.containsKey("I") && rowValues.get("I").equals("Code") &&
                        rowValues.containsKey("J") && rowValues.get("J").equals("Description") &&
                        rowValues.containsKey("K") && rowValues.get("K").equals("Code System") &&
                        rowValues.containsKey("L") && rowValues.get("L").equals("Code System OID") &&
                        rowValues.containsKey("M") && rowValues.get("M").equals("Code System Version") &&
                        rowValues.containsKey("N") && rowValues.get("N").equals("Expansion ID")) {
                    titleRow = true;
                }
                return titleRow;
            }
...
//                createIndexFile();
            ...
            //TODO: we may not need to create separate index files
